...
extern "C" {
#endif // __cplusplus
    extern void render_fractal(int32_t width, int32_t height, int32_t n, float x_min, float x_max, float y_min, float y_max, float tolerance, int32_t max_iterations, struct Complex * roots, int32_t * output);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
